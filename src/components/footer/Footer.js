...
function Footer() {
    return (
        <footer className="sticky top-[100vh] footer mb-0 w-full bottom-0 gap-5 flex flex-col md:flex-row justify-between md:items-center p-4 bg-gradient-to-r from-[#0F0F0F] to-[#000] text-yellow-300">
