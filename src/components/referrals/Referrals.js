...
function Referrals() {
  ...
  return (
    <div className="flex justify-center items-center flex-col px-5 h-[100dvh] pb-0 md:pb-[100px]">
      <div className="bg-[#000] py-5 px-10 rounded-lg w-[100%] md:w-[50%]">
        <div className="flex items-center md:gap-8">
          {" "}
          {/* http://localhost:3000/ */} {/* https://flipgamers.netlify.app */}
          <button
            onClick={() =>
              handleCopyClick(
          ...
          >
            {isCopied ? (
              <div className="text-[#FFF]">Copied!</div>
            ) : (
              <svg
      ...
      <div className=" w-full md:w-[70%] border-2 border-[#FFF]  to-[#0F0F0F] from-[#000] bg-gradient-to-br mt-10 rounded-md">
